...
collection2 = db["EngReccSampleData_class_words"]
collection3 = db["EngReccSampleData.corpus_words"]

class_words = collection2.find_one({}) # query
corpus_words = collection3.find_one({}) # query
'''
